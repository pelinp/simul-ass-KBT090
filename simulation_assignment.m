...
% en annan tanke jag hade var att, om vi istället för att ha PI control,
% kan man simulera att man har det och öka flödet med samma mönster som man
% får när man simulerar det?

% man skulle också kunna öka flödet lite för varje gång (varje
% tidsintervall) som man kör...
...
Volume=[Flows,Ytot(:,5)];
Extra=[Ytot(:,1)/0.18,Ytot(:,2),Ytot(:,3)]; %Y(:,1) är i mmol/L inte g/L som jag trodde
